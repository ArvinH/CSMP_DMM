...
@WebServlet("/Insert_API_puchaseorders")
public class Backup_puchaseorders extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private String Replace_dbTableSechema = "replace into opportunities(id,deleted,SME_ID,date_entered,date_modified,"+
						"modified_user_id,created_by,description,assigned_user_id,subject,quoteid,vendorid,requisition_no,"+
						"tracking_no,contactid,duedate,carrier,postatus,salescommission,exciseduty,subtotal,adjustment,total,"+
						"taxtype,discount_percent,discount_amount,s_h_amount,terms_conditions,currency_id,conversion_rate,billing_address_street,"+
						"billing_address_city,billing_address_state,billing_address_postalcode,billing_address_country,billing_address_pobox,"+
	...
	protected void doPost(HttpServletRequest request,
		...
		requisition_no = URLDecoder.decode(request.getParameter("requisition_no"),"UTF-8");
		tracking_no = URLDecoder.decode(request.getParameter("tracking_no"),"UTF-8");
		...
		postatus = URLDecoder.decode(request.getParameter("postatus"),"UTF-8");
