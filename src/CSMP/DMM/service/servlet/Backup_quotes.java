...
@WebServlet("/Insert_API_quotes")
public class Backup_quotes extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private String Replace_dbTableSechema = "replace into opportunities(id,deleted,SME_ID,date_entered,date_modified,"+
						"modified_user_id,created_by,description,assigned_user_id,subject,opportunityid,accountid,quotestatus,"+
						"validtill,contactid,carrier,shipping,inventorymanager,subtotal,adjustment,total,taxtype,discount_percent,"+
						"discount_amount,s_h_amount,terms_conditions,currency,conversion_rate,billing_address_street,billing_address_city,"+
						"billing_address_state,billing_address_postalcode,billing_address_country,billing_address_pobox,shipping_address_street,"+
	...
	protected void doPost(HttpServletRequest request,
		...
		quotestatus = URLDecoder.decode(request.getParameter("quotestatus"),"UTF-8");
		validtill = URLDecoder.decode(request.getParameter("validtill"),"UTF-8");
		...
		shipping = URLDecoder.decode(request.getParameter("shipping"),"UTF-8");
		inventorymanager = URLDecoder.decode(request.getParameter("inventorymanager"),"UTF-8");
