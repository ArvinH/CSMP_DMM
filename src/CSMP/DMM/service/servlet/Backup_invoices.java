...
@WebServlet("/Insert_API_invoices")
public class Backup_invoices extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private String Replace_dbTableSechema = "replace into opportunities(id,deleted,SME_ID,date_entered,date_modified,"+
					"modified_user_id,created_by,description,assigned_user_id,salesorderid,subject,opportunityid,accountid,"+
					"quoteid,purchaseorder,contactid,vendorid,duedate,carrier,sostatus,pending,salescommission,exciseduty,subtotal,"+
					"adjustment,total,taxtype,discount_percent,discount_amount,s_h_amount,terms_conditions,currency_id,conversion_rate,"+
					"billing_address_street,billing_address_city,billing_address_state,billing_address_postalcode,billing_address_country,"+
					"billing_address_pobox,shipping_address_street,shipping_address_city,shipping_address_state,shipping_address_postalcode,"+
					"shipping_address_country,shipping_address_pobox) ";
	...
	protected void doPost(HttpServletRequest request,
		...
		salesorderid = URLDecoder.decode(request.getParameter("salesorderid"),"UTF-8");
